...
eqcs(t)$((ord(t) GE tmin) and (ord(t) LE Tmax) )..
                                   (   - cs(t)**(-gammae) + mut(t)+ betae * sum(nz, prob(nz)* cne(t,nz)**(-gammae) * (1-deltae
...
eqcont(t,nz)$((ord(t) GE tmin) and (ord(t) LE Tmax) )..                      ((1/betae+deltae-1)/alphake)*exp(zne(t,nz))*
                                                                                   (  ke(t+1)$(ord(t) LT Tmax)
                                                                                    + kfin$(ord(t) EQ tmax)
                                                                                   )**alphake - cne(t,nz)   =G= invmin;

*eqcont1(t,nz)$((ord(t) GE tmin) and (ord(t) LE Tmax) )..                      (((1/betae+deltae-1)/alphake)*exp(zne(t,nz))*
*                                                                                   (  ke(t+1)$(ord(t) LT Tmax)
*                                                                                    + kfin$(ord(t) EQ tmax)
*                                                                                   )**alphake - cne(t,nz))*mutne(t,nz) =e=  0;

*eqmut(t)$((ord(t) GE tmin) and (ord(t) LE Tmax) )..                           mut(t)*(ys(t)-cs(t)-invmin) =e= 0;
...
execute_unload 'rbc_cs_invmin_fix_gamma_mea.gdx';
